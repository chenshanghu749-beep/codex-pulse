...
<p align="center">
  <img alt="Release" src="https://img.shields.io/badge/release-2.4.5-111111">
...
Download [`Codex-Pulse-2.4.5.dmg`](dist/Codex-Pulse-2.4.5.dmg), open it, and drag `Codex Pulse.app` into `Applications`.
...
The app is generated at `build/Codex Pulse.app`, and the installer is generated at `dist/Codex-Pulse-2.4.5.dmg`.
